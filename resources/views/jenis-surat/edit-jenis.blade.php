        ...
        <div class="col-lg-9 bg-white pt-4 shadow-sm" style="border-radius:15px">
            ...
            <form action="/save-jenis" method="POST" class="forms-sample row" enctype="multipart/form-data">
                ...
                <div class="my-3">
                    ...
                    <input type="text" name="kodeSurat" class="form-control" placeholder="Jenis Surat" value="{{ $data->kodeSurat }}">
                    @error('pengirim')
                ...
                <div class="my-3">
                    ...
                    <input type="text" name="keterangan" class="form-control" placeholder="Keterangan Surat" value="{{ $data->keterangan }}">
                    @error('pengirim')
                    <div id="emailHelp" class="form-text text-danger">{{ $message}}</div>
                    @enderror
                </div>
