                        ...
                        <div class="col-8">
                                    ...
                                    <div class="card border-0 shadow-sm py-3"
                                        ...
                                        <div class="card-body col text-white">
                                            <div class="row position-relative">
                                                <div class="col">
                                                    <h4 class="card-title fw-bold mb-4" style="letter-spacing:1.8px">
                                                        What is
                                                        Surat.in function?</h4>
                                                    <p class="card-text mb-4">Surat.in is an website base application to
                                                        manage
                                                        message</p>
                            ...
                            <div class="row" style="margin-top:30px ">
                                <div class="col-lg-4 px-1">
                                    <div class="card border-0 shadow-sm bg-white position-relative"
